<?php $__env->startSection('title', 'Seller Notifications'); ?>
            ...
            <div class="dashboard-layout">
                ...
                <main class="dashboard-main">
                    <div class="seller-notifications-page" data-seller-notifications-page
                        data-current-filter="<?php echo e($filter); ?>"
                        data-current-page="<?php echo e($notifications->currentPage()); ?>"
                        data-per-page="<?php echo e($notifications->perPage()); ?>">
                        <?php echo $__env->make('seller.notifications.partials.toolbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php echo $__env->make('seller.notifications.partials.summary', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php echo $__env->make('seller.notifications.partials.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </main>
            </div>
        </div>
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e($sellerNotificationsScript); ?>" defer></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.seller', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kirlg\LocalLiftPH\resources\views/seller/notifications.blade.php ENDPATH**/ ?>