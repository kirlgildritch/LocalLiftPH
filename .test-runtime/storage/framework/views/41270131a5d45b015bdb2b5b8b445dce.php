<footer>
    <div class="container footer-top">
        ...
        <div class="footer-col">
            <h4>Marketplace</h4>
            <ul>
                <li><a href="<?php echo e(route('home')); ?>">Overview</a></li>
                <li><a href="<?php echo e(route('shops.index')); ?>">Featured Shops</a></li>
                <li><a href="<?php echo e(route('products.index')); ?>">Products</a></li>
                <li><a href="<?php echo e(route('about')); ?>">About LocalLift</a></li>
            </ul>
        </div>
        ...
        <div class="footer-col">
            <h4>For Sellers</h4>
            <ul>
                <li><a href="<?php echo e(route('seller.register')); ?>">Create a Shop</a></li>
                <li><a href="<?php echo e(route('seller.center')); ?>">Seller Access</a></li>
                <li><a href="<?php echo e(route('products.index')); ?>">Product Discovery</a></li>
...
</footer><?php /**PATH C:\Users\kirlg\LocalLiftPH\resources\views/partials/footer.blade.php ENDPATH**/ ?>