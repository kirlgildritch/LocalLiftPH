                        ...
                        <div class="edit-product-shell">
                            ...
                            <form class="product-form edit-product-form" action="<?php echo e(route('seller.products.update', $product)); ?>"
                                ...
                                <section class="edit-section-card">
                                    ...
                                    <?php echo $__env->make('seller.products.partials.form.basic-information', [
                                ...
                                <section class="edit-section-card">
                                    ...
                                    <?php echo $__env->make('seller.products.partials.form.pricing-fields', [
                                        'priceValue' => old('price', $product->price ?? ''),
                                        'stockValue' => old('stock', $product->stock ?? ''),
                                        'wrapperClass' => 'form-grid edit-two-column-grid',
                                    ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                                    <?php echo $__env->make('seller.products.partials.form.variant-builder', [
                                ...
                                <section class="edit-section-card">
                                    ...
                                    <?php echo $__env->make('seller.products.partials.form.media-picker', [
...
unset($__errorArgs, $__bag); ?>
    ...
    <script src="<?php echo e($sellerProductFormScript); ?>" defer></script>
