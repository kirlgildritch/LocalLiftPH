                           ...
                           <form action="{{ route('seller.settings.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    @if(!empty($seller->shop_logo))
                                        <img src="{{ asset('storage/' . $seller->shop_logo) }}" width="80">
                                    @endif

                                    <input type="file" name="shop_logo" accept="image/*">
                                </div>

                                <button type="submit" class="save-btn">Save General Settings</button>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="settings-card">
                            ...
                            <form action="{{ route('seller.settings.notifications') }}" method="POST">
                                ...
                                <div class="checkbox-group">
                                    <label>
                                        <input type="checkbox" name="notify_orders" value="1"
                                            {{ old('notify_orders', $seller->notify_orders ?? 1) ? 'checked' : '' }}>
                                ...
                                <div class="checkbox-group">
                                    <label>
                                        <input type="checkbox" name="notify_messages" value="1"
                                            {{ old('notify_messages', $seller->notify_messages ?? 1) ? 'checked' : '' }}>
                                ...
                                <div class="checkbox-group">
                                    <label>
                                        <input type="checkbox" name="notify_low_stock" value="1"
                                            {{ old('notify_low_stock', $seller->notify_low_stock ?? 0) ? 'checked' : '' }}>
                                        Low stock alerts
                                    </label>
                                </div>
                                ...
                                <div class="checkbox-group">
                                    <label>
                                        <input type="checkbox" name="notify_promotions" value="1"
                                            {{ old('notify_promotions', $seller->notify_promotions ?? 0) ? 'checked' : '' }}>
                    ...
                    <div id="policies" class="settings-tab-content">
                        <div class="settings-card">
                            ...
                            <form action="{{ route('seller.settings.policies') }}" method="POST">
                                ...
                                <button type="submit" class="save-btn">Save Store Policies</button>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="settings-card">
                            ...
                            <form action="{{ route('seller.settings.payout') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="gcash_number" name="gcash_number" value="{{ old('gcash_number', $seller->gcash_number ?? '') }}">
                                </div>

                                <div class="form-group">
                                    <label for="bank_name">Bank Name</label>
                                    <input type="text" id="bank_name" name="bank_name" value="{{ old('bank_name', $seller->bank_name ?? '') }}">
                                </div>

                                <div class="form-group">
                                    <label for="account_name">Account Name</label>
                                    <input type="text" id="account_name" name="account_name" value="{{ old('account_name', $seller->account_name ?? '') }}">
                                </div>

                                <div class="form-group">
                                    <label for="account_number">Account Number</label>
                                    <input type="text" id="account_number" name="account_number" value="{{ old('account_number', $seller->account_number ?? '') }}">
                                </div>
                    ...
                    <div id="inventory" class="settings-tab-content">
                        <div class="settings-card">
                            ...
                            <form action="{{ route('seller.settings.inventory') }}" method="POST">
                                ...
                                <div class="checkbox-group">
                                    <label>
                                        <input type="checkbox" name="hide_out_of_stock" value="1"
                                            {{ old('hide_out_of_stock', $seller->hide_out_of_stock ?? 0) ? 'checked' : '' }}>
                                        Hide out-of-stock products
                                    </label>
                                </div>

                                <button type="submit" class="save-btn">Save Inventory Settings</button>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="settings-card">
                            ...
                            <form action="{{ route('seller.settings.status') }}" method="POST">
                                ...
                                <div class="radio-group">
                                    <label>
                                        <input type="radio" name="shop_status" value="open"
                                            {{ old('shop_status', $seller->shop_status ?? 'open') === 'open' ? 'checked' : '' }}>
                                        Open
                                    </label>
                                </div>
                                ...
                                <div class="radio-group">
                                    <label>
                                        <input type="radio" name="shop_status" value="closed"
                                            {{ old('shop_status', $seller->shop_status ?? '') === 'closed' ? 'checked' : '' }}>
                                        Temporarily Closed
                                    </label>
                                </div>
                                ...
                                <div class="radio-group">
                                    <label>
                                        <input type="radio" name="shop_status" value="vacation"
                                            {{ old('shop_status', $seller->shop_status ?? '') === 'vacation' ? 'checked' : '' }}>
                                        Vacation Mode
                                    </label>
                                </div>

                                <button type="submit" class="save-btn">Save Shop Status</button>
                            </form>
                        </div>
                    </div>
