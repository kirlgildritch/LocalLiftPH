                    ...
                    <form class="product-form" action="{{ route('seller.products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="price" name="price" step="0.01" min="0" value="{{ old('price') }}" placeholder="PHP">
                                @error('price')
                                    <small class="error-text">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group form-group-wide">
                                ...
                                <div class="shipping-summary">
                                    ...
                                    <button type="button" class="page-action-btn shipping-open-btn" id="openShippingModal">
                                        Set Shipping Fee
                                    </button>
                                </div>
                                @error('weight')
