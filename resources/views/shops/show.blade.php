        ...
        <div class="shop-hero panel">
            ...
            <div class="shop-hero-card">
                <div class="shop-hero-art">
                    <img
                        src="{{ !empty($user->profile_image) ? asset('storage/' . $user->profile_image) : asset('assets/images/default-product.png') }}"
                        alt="{{ $user->name }}"
                    >
                </div>
        ...
        <div class="shop-detail-layout">
            ...
            <div class="shop-main">
                ...
                <div class="detail-section-grid">
                    <section class="panel detail-panel" id="shop-about">
                        <span class="section-kicker">About The Shop</span>
                        <h2>{{ $user->name }}</h2>
                        <p>
                            This shop is part of the LocalLift marketplace. Browse seller products and support local businesses through a cleaner storefront experience.
                        </p>
                    </section>
                </div>
            </div>
